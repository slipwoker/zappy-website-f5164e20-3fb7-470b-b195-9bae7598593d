document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0) {
    animatableElements.forEach(function (el) {
      el.classList.add('scroll-animate-pending');
    });
    ...
    function activateElement(el) {
      const delay = el.dataset.delay || el.dataset.animateDelay;
      if (delay) {
        el.style.transitionDelay = delay;
        el.style.animationDelay = delay;
      }

      el.classList.remove('scroll-animate-pending');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Airpure משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f5164e20-3fb7-470b-b195-9bae7598593d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f5164e20-3fb7-470b-b195-9bae7598593d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f5164e20-3fb7-470b-b195-9bae7598593d';
